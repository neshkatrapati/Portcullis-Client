...
<?php require_once 'connectioncli.php'; ?>
   <table cellpadding='20px'><tr><td><a href="http://jntu.ac.in/" title="JNTU"><img src="Portcullisimage.png" alt=""  width='100' height="100"/>&emsp;<img src="images/jntulogo.jpg" alt=""/></a>&emsp;</td>
    &emsp;<td>&emsp;<h2>
      ...
      Kukatpally,Hyderabad - 500 085, Andhra Pradesh, India</h2>		<h2><?php echo COLLEGENAME; ?></h2></td></tr></table></center>
...
<?php
	...
	while($row = mysql_fetch_array($q))
	{
		...
		$table = $row["rtabname"];
		$resname = $row["rname"];
		echo "<a href='result.php?resid=".$table."' style='display:block'>".$resname."</a><br>";
